  ...
  <xsl:template match="/">
    ...
    <body style="background-image:url('images/background3.jpg')">
        <div id="wrapper">
            ...
            <tr>
            <td></td>
            <td> <input type="submit" class="button" style="width: 300px;" value="Αναζήτηση"/></td>
            </tr>
            </table>
            ...
            <div id="advacedsearch2">
              ...
              <option value="2007">2007</option>
                        ...
                        <tr>
                            <td></td>
                            <td><div class="button2" style="width: 180px; height: 20px;" ><a href="advancedsearch" style="font-size:21px;">Προχωρημένη Αναζήτηση</a></div></td>
                        </tr>
                    </table>
                </form>
                </div>
